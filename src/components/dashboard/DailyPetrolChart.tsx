...
export function DailyPetrolChart({ data }: { data: DailyBreakdownPoint[] }) {
  return (
    <ChartCard title="Daily Petrol Expense">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ left: 0, right: 8, top: 8, bottom: 0 }}>
          ...
          <Bar dataKey="petrol" fill="#dc2626" radius={[4, 4, 0, 0]} maxBarSize={24} />
        </BarChart>
      </ResponsiveContainer>
    </ChartCard>
  )
